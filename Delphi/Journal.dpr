...
uses
  ...
  TermineForm in 'src\Forms\TermineForm.pas' {TermineForm},
  TerminEditForm in 'src\Forms\TerminEditForm.pas' {TerminEditForm},
  ...
  Journal.Appointments in 'src\Core\Journal.Appointments.pas',
